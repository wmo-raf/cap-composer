...
class PolygonFieldBlock(FieldBlock):
    ...
    def value_for_form(self, value):
        if value:
            return GEOSGeometry(value).json
        return value
...
class AlertArea(blocks.StructBlock):
    ...
    polygon = PolygonFieldBlock(srid=4326, label=_("Polygon"),
                                help_text=_("The paired values of points defining a polygon that delineates "
                                            "the affected area of the alert message"))
    altitude = blocks.CharBlock(max_length=100, required=False, verbose_name=_("Altitude"),
                                help_text=_("The specific or minimum altitude of the affected "
                                            "area of the alert message"))
    ceiling = blocks.CharBlock(max_length=100, required=False, verbose_name=_("Ceiling"),
...
class AlertInfo(blocks.StructBlock):
    ...
    event = blocks.CharBlock(max_length=255, verbose_name=_("Event"),
    ...
    onset = blocks.DateTimeBlock(required=False, verbose_name=_("Onset"),
    ...
    senderName = blocks.CharBlock(max_length=255, label=_("Sender name"), required=False,
                                  help_text=_("The human-readable name of the agency or authority issuing this alert."))
    ...
    contact = blocks.CharBlock(max_length=255, required=False, label=_("Contact"),
                               help_text=_("The text describing the contact for follow-up and "
                                           "confirmation of the alert message"))

    area = blocks.ListBlock(AlertArea(), label="Alert Areas")
